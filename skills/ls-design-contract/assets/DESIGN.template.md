...
**Premise.** {{premise_sentence}}

**Evidence.** {{premise_evidence}}

**Direction.** Primary family: {{direction_family}}. Quiet counterpoint: {{direction_counterpoint}}. Signature element: {{signature_element}}.

**Excluded on purpose.** {{direction_exclusions}}
...
|---|---|---|---|
| content | background | 4.5:1 | {{contrast_content_background}} |
| content-muted | background | 4.5:1 | {{contrast_muted_background}} |
| content | surface | 4.5:1 | {{contrast_content_surface}} |
| on-primary | primary | 4.5:1 | {{contrast_onprimary_primary}} |
| border-strong | surface | 3.0:1 | {{contrast_border_surface}} |
...
`sm` for inputs and small chips, `md` for inputs and compact cards, `lg` for cards and media frames, `full` for pills and avatars. {{shape_signature}}
...
Baseline WCAG 2.1 AA, target WCAG 2.2 AA including focus not obscured and a 24-pixel minimum target size. Visible focus on every interactive element. Reduced motion honored globally. {{accessibility_notes}}
